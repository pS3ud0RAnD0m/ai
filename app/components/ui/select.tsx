  ...
  return (
    <span
      ...
      className={clsx([
        ...
        "dark:before:hidden",
        // Focus ring
        "after:pointer-events-none after:absolute after:inset-0 after:rounded-lg after:ring-inset after:ring-transparent has-data-focus:after:ring-2 has-data-focus:after:ring-blue-500",
        // Disabled state
