...
export function Navbar({
  ...
  return (
      <nav
          {...props}
          className={clsx(className, "flex items-center justify-start gap-4 py-0 px-4")}
      >
        {/* Add the Navbar items here */}
        <NavbarItem href="/" current={true}>navbarItem1</NavbarItem>
        <NavbarItem href="/page2">navbarItem2</NavbarItem>
        <NavbarItem href="/page3">navbarItem3</NavbarItem>
      </nav>
  );
}
