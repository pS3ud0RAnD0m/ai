...
function ProviderDropdown() {
    ...
    return (
        <div className="mb-4">
            ...
            <Headless.Listbox>
                <Headless.Listbox.Button className="w-full rounded-md border border-gray-300 bg-white py-2 px-3 text-left shadow-sm focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500 sm:text-sm dark:bg-gray-900 dark:border-gray-700 dark:text-gray-300">
                    Select provider
                </Headless.Listbox.Button>
                <Headless.Listbox.Options className="absolute z-10 mt-1 w-full rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm dark:bg-gray-900 dark:text-gray-300">
...
export function SidebarHeader({ className, ...props }: React.ComponentPropsWithoutRef<"div">) {
    return (
        <div {...props} className={clsx(className, "border-b border-gray-300 p-4 dark:border-gray-700")} />
    );
}
